...
| *Interne Stakeholder*
| Sind Anteilhaber oder Eigentümer des Unternehmens.    
  Können aber auch Mitarbeiter sein.
| -liefern von Informationen 
   - Kommunikation zwischen allen Stakeholdern
   -der jenige der bezahlt
...
|*Externe Stakeholder*
|Sind Kunden,Lieferanten oder sogar der Staat. Greifen von außerhalb auf das Unternehmen zu
|-verantwortich für die Nachfrage der Produkte
